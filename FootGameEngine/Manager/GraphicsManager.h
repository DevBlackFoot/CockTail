...
namespace GameEngineSpace
{
	...
	public:
		...
		// 빛 던지기
		void PassDirectionalLight(SimpleMath::Vector3 color, SimpleMath::Vector3 direction, float power, bool isShadow, SimpleMath::Matrix lightViewProj);
		...
		std::shared_ptr<Texture> LoadPrefabTexture(std::wstring path);
