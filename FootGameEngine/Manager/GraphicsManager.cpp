...
namespace GameEngineSpace
{
	...
	bool GraphicsManager::UIUtilInit()
	{
		renderer->UIUtilsInitialize();
	...
	void GraphicsManager::PassDirectionalLight(SimpleMath::Vector3 color, SimpleMath::Vector3 direction, float power, bool isShadow, SimpleMath::Matrix lightViewProj)
	{
		renderer->PassDirectionalLight(color, direction, power, isShadow, lightViewProj);
	}
	...
	void GraphicsManager::PassIndoor(bool isIndoor)
	{
		renderer->PassIndoor(isIndoor);
	}
	...
	std::shared_ptr<Texture> GraphicsManager::LoadPrefabTexture(std::wstring path)
	{
		return resourceManager->LoadPrefabTexture(path);
	}
	...
	void GraphicsManager::FadeIn(float speed)
	{
		renderer->FadeIn(speed);
	}

	void GraphicsManager::FadeOut(float speed)
	{
