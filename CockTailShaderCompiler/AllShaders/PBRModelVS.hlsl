...
cbuffer cbTransObj : register( b3 )
{
    float4 offset;
}
...
VS_Output main(VS_Input vin)
{
	...
	// 투명 오브젝트의 처리.. Skin Obj를 위한.
		// 버텍스의 위치 자체를 살짝 변경해봅니다..
#ifdef TRANSPARENTOBJ
	//pos += (normal * 0.001f);
	pos += (normal * offset.x);
#endif
...
// 몬스터를 위한 VS 추가.
	// 무조건 스키닝이라 가정..
VS_Monster_Output monMain(VS_Input vin)
{
    VS_Monster_Output vout = (VS_Monster_Output) 0;
