// 파티클에 사용되는 각종 Define들을 모아둔 파일입니다.
	// By. 성현
	// 기본적으로 컨벤션에 따라 바꾼 이름에 맞춰줍니다..
...
#define Use_VelocityOverLifetime 1 << 3 // Velocity_Over_Lifetime Module
#define Use_ForceOverLifetime 1 << 4 // Force_over_Lifetime Module
#define Use_ColorOverLifetime 1 << 5 // Color_over_Lifetime Module
#define Use_SizeOverLifetime 1 << 6 // Size_over_Lifetime Module
#define Use_RotationOverLifetime 1 << 7 // Rotation_over_Lifetime Module
#define Use_Noise 1 << 8 // Noise Module
#define Use_Collision 1 << 9 // Collision Module
#define Use_TextureSheetAnimation  1 << 10 // Texture_Sheet_Animation Module
