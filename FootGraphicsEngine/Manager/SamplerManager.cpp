...
namespace GraphicsEngineSpace
{
	...
	void SamplerManager::Init(ComPtr<ID3D11Device> device)
	{
		...
		samDesc3.ComparisonFunc = D3D11_COMPARISON_ALWAYS;
		...
		samDesc4.Filter = D3D11_FILTER_MIN_MAG_MIP_POINT;

		hr = device->CreateSamplerState(&samDesc4, pointClampSamplerState.GetAddressOf());
