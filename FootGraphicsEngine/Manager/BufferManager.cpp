...
namespace GraphicsEngineSpace
{
	...
	void BufferManager::Init(ComPtr<ID3D11Device> _device, ComPtr<ID3D11DeviceContext> _deviceContext)
	{
		...
		CreateConstantBuffer("ThresholdCB", sizeof(SimpleMath::Vector4));
		...
		// Particle Buffer
		CreateConstantBuffer("DynamicBufferCB", sizeof(ConstantBufferDesc::cbDynamicBuffer));
		CreateConstantBuffer("PerObjectParticleCB", sizeof(ConstantBufferDesc::cbPerObjectParticle));
	}
