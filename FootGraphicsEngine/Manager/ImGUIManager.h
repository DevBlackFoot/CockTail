...
namespace GraphicsEngineSpace
{
	...
	public:
		...
		// 현재 열려있는지를 확인하는 함수를 만들어줍니다.
		bool GetBool(std::string checkLabel);
		...
		// Text Input 관련 함수들
		bool InputText(std::string label, char* text, unsigned int bufferSize);
		bool InputText(std::string label, std::string hint, char* text, unsigned int bufferSize);
