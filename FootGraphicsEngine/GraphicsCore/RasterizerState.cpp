...
namespace GraphicsEngineSpace
{
	...
	ComPtr<ID3D11RasterizerState> RasterizerState::noDepthRS = nullptr;
	ComPtr<ID3D11RasterizerState> RasterizerState::skyBoxRS = nullptr;
	...
	bool RasterizerState::InitAllRS(ComPtr<ID3D11Device> pDevice)
	{
		...
		HR(pDevice->CreateRasterizerState(&rsDesc, noDepthRS.GetAddressOf()));

		rsDesc.CullMode = D3D11_CULL_NONE;
		HR(pDevice->CreateRasterizerState(&rsDesc, skyBoxRS.GetAddressOf()));
		...
		depthRsDesc.CullMode = D3D11_CULL_BACK;
